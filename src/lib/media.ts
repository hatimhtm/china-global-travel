...
export const heroVideo = {
  poster: 'https://images.unsplash.com/photo-1502784444187-359ac186c5bb?auto=format&fit=crop&w=2400&q=70',
  sources: [
    // Drone-feel mist mountains — Pexels royalty-free
    { src: 'https://videos.pexels.com/video-files/2491284/2491284-uhd_3840_2160_24fps.mp4', type: 'video/mp4' },
  ],
};

export const photos = {
  // Destinations
  wuyuan: 'https://images.unsplash.com/photo-1545569310-92ce81b9c0c5?auto=format&fit=crop&w=2000&q=70',
  lushan: 'https://images.unsplash.com/photo-1513415756790-2ac1db1297d0?auto=format&fit=crop&w=2000&q=70',
  jingdezhen: 'https://images.unsplash.com/photo-1565193298434-a9c8c8c10ffd?auto=format&fit=crop&w=2000&q=70',
  longhu: 'https://images.unsplash.com/photo-1547558420-95cb5e0bce1b?auto=format&fit=crop&w=2000&q=70',
  sanqingshan: 'https://images.unsplash.com/photo-1518002171953-a080ee817e1f?auto=format&fit=crop&w=2000&q=70',
  wugong: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?auto=format&fit=crop&w=2000&q=70',
  poyang: 'https://images.unsplash.com/photo-1500301111609-42f1aa6df72a?auto=format&fit=crop&w=2000&q=70',
  tengwang: 'https://images.unsplash.com/photo-1547981609-4b6bfe67ca0b?auto=format&fit=crop&w=2000&q=70',

  // Journey hero images
  essential: 'https://images.unsplash.com/photo-1528127269322-539801943592?auto=format&fit=crop&w=2400&q=70',
  inDepth: 'https://images.unsplash.com/photo-1551405780-03882d5a2ba7?auto=format&fit=crop&w=2400&q=70',
  heritage: 'https://images.unsplash.com/photo-1473625247510-8ceb1760943f?auto=format&fit=crop&w=2400&q=70',
